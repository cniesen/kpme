				...
				<table id="tblNewTimeBlocks" style="border-collapse:collapse;border: 1px solid #000;">
                    ...
                    <tbody>
                        <tr>
							...
							<td>
								<input disabled id="hrRowFirst" class="hrRow" size="5" />
							</td>
                            <td>
                        ...
                        <tr>
							...
							<td colspan="2" align="left">
								<input disabled type="text" id="etRowLast" class="etRow" size="10" value="${Form.currentTimeBlock.endTimeDisplayTimeOnlyString}" />
							</td>
							<td>
