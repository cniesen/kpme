...
public class SalaryGroupKeyBo extends HrBusinessObjectKey<SalaryGroupBo, SalaryGroupKeyBo> {
	 ...
	 */
    public static final ModelObjectUtils.Transformer<EffectiveKey, SalaryGroupKeyBo> toBo = new ModelObjectUtils.Transformer<EffectiveKey, SalaryGroupKeyBo>() {
	 ...
	 */
    public static final ModelObjectUtils.Transformer<SalaryGroupKeyBo, EffectiveKey> toImmutable = new ModelObjectUtils.Transformer<SalaryGroupKeyBo, EffectiveKey>() {
