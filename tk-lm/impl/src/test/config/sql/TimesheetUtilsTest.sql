...
insert into tk_time_block_t (`tk_time_block_id`, `document_id`, `job_number`, `work_area`, `task`, `earn_code`, `begin_ts`, `end_ts`, `clock_log_created`, `hours`, `ttl_min`, `amount`, `user_principal_id`, `timestamp`, `obj_id`, `ver_nbr`, `clock_log_begin_id`, `clock_log_end_id`, `principal_id`, `ovt_pref`, `lunch_deleted`, `GRP_KEY_CD`) values('5000', '5001', '19', '20', '30', 'EC1', '2012-01-07 23:00:00', '2012-01-08 01:00:00', 'N', 2, 120, null, '10001', now(), 'B2991ADA-E866-F28C-7E95-A897AC377D0D', '1', null, null, 'testUser2', null, 'Y', 'IU-IN');
insert into tk_time_block_t (`tk_time_block_id`, `document_id`, `job_number`, `work_area`, `task`, `earn_code`, `begin_ts`, `end_ts`, `clock_log_created`, `hours`, `ttl_min`, `amount`, `user_principal_id`, `timestamp`, `obj_id`, `ver_nbr`, `clock_log_begin_id`, `clock_log_end_id`, `principal_id`, `ovt_pref`, `lunch_deleted`, `GRP_KEY_CD`) values('5001', '5001', '19', '20', '30', 'EC1', '2012-01-07 19:00:00', '2012-01-07 20:00:00', 'N', 1, 60, null, '10001', now(), 'B2991ADA-E866-F28C-7E95-A897AC377D0E', '1', null, null, 'testUser2', null, 'Y', 'IU-IN');
