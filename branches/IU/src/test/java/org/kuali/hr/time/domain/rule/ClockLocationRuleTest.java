...
import org.kuali.hr.time.BaseTestCase;
import org.kuali.rice.kns.service.BusinessObjectService;
import org.kuali.rice.kns.service.KNSServiceLocator;

public class ClockLocationRuleTest  extends BaseTestCase {
	...
	public void testSave() throws Exception {
		...
		clr.setEffectiveSequence(BigDecimal.ZERO);
		...
		assertEquals("One entry should be in list.", collection.size(), 1);
