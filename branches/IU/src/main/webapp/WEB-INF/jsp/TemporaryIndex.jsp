        ...
        <td width="33%" valign="top">
           ...
           <div class="portlet">
              ...
              <div class="portlet-content">
                    ...
                    <a href="https://${pageContext.request.serverName}:${pageContext.request.serverPort}/kr-${StrutsActionForm.environment}/kew/RuleQuickLinks.do?rootDocTypeName=TKDocument">Delegate Maintenance Doc</a><br/>
                    <a href="https://${pageContext.request.serverName}:${pageContext.request.serverPort}/kr-${StrutsActionForm.environment}/kew/DocumentSearch.do">Document Search</a><br/>
