...
public class JobServiceImplTest extends KPMETestCase {
	...
	public void testSearchJobs() throws Exception {
		List<Job> allResults = TkServiceLocator.getJobService().getJobs("admin", null, null, null, null, null, null, null, null, null, "Y", "N");
		Assert.assertEquals("Search returned the wrong number of results.", 9, allResults.size());
		
		List<Job> restrictedResults = TkServiceLocator.getJobService().getJobs("testuser6", null, null, null, null, null, null, null, null, null, "Y", "N");
