...
public class EarnCodeSecurityServiceImplTest extends KPMETestCase {
	...
	public void testSearchEarnCodeSecurities() throws Exception {
		List<EarnCodeSecurity> allResults = TkServiceLocator.getEarnCodeSecurityService().searchEarnCodeSecurities("admin", null, null, null, null, null, null, "Y", "N");
		Assert.assertEquals("Search returned the wrong number of results.", 18, allResults.size());
		
		List<EarnCodeSecurity> restrictedResults = TkServiceLocator.getEarnCodeSecurityService().searchEarnCodeSecurities("testuser6", null, null, null, null, null, null, "Y", "N");
