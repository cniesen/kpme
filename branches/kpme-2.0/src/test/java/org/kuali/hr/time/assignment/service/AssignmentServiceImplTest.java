...
public class AssignmentServiceImplTest extends KPMETestCase {
	...
	public void testSearchAssignments() throws Exception {
		List<Assignment> allResults = TkServiceLocator.getAssignmentService().searchAssignments("admin", null, null, null, null, null, null, "Y", "N");
		Assert.assertEquals("Search returned the wrong number of results.", 14, allResults.size());
		
		List<Assignment> restrictedResults = TkServiceLocator.getAssignmentService().searchAssignments("testuser6", null, null, null, null, null, null, "Y", "N");
