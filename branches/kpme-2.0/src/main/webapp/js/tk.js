 ...
 // create navigation buttons for leave calendar
   ...
   $('#nav_prev_ac').button({
    ...
    $('#missed-punch-iframe-button').click(function() {
        ...
        $('#missed-punch-dialog').append('<iframe width="1024" height="650" src="kr-krad/missedPunch?viewId=MissedPunch-SubmitView&methodToCall=start&dataObjectClassName=org.kuali.hr.time.missedpunch.MissedPunch&timesheetDocumentId=' + tdocid + '"></iframe>');
