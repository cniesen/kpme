...
public class LeaveCalendarServiceImpl implements LeaveCalendarService {
    ...
    public LeaveCalendarDocument getLeaveCalendarDocument(String documentId) {
        ...
        if (lcdh != null) {
            ...
            CalendarEntry pce = TkServiceLocator.getCalendarService().getCalendarDatesByPayEndDate(lcdh.getPrincipalId(), lcdh.getEndDateTime(), LMConstants.LEAVE_CALENDAR_TYPE);
