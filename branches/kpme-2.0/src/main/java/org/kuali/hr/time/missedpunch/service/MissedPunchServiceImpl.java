...
public class MissedPunchServiceImpl implements MissedPunchService {
    ...
    public void addClockLog(MissedPunch missedPunch, String ipAddress) {
        ...
        String assignmentDescriptionKey = new AssignmentDescriptionKey(missedPunch.getJobNumber(), missedPunch.getWorkArea(), missedPunch.getTask()).toAssignmentKeyString();
        Assignment assignment = getAssignmentService().getAssignment(timesheetDocument, assignmentDescriptionKey);
    ...
    private void buildTimeBlockRunRules(ClockLog beginClockLog, ClockLog endClockLog, TimesheetDocument tdoc, Assignment assignment, String earnCode, DateTime beginDateTime, DateTime endDateTime) {
        ...
        getTimeBlockService().saveTimeBlocks(referenceTimeBlocks, newTimeBlocks, TKContext.getPrincipalId());
    }
