...
public class SystemScheduledTimeOffLookupableHelper extends KPMELookupableHelper {
    ...
    public List<? extends BusinessObject> getSearchResults(Map<String, String> fieldValues) {
        ...
        return TkServiceLocator.getSysSchTimeOffService().getSystemScheduledTimeOffs(GlobalVariables.getUserSession().getPrincipalId(), TKUtils.formatDateString(fromEffdt), TKUtils.formatDateString(toEffdt), 
