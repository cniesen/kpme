...
public class LeaveBlock extends PersistableBusinessObjectBase {
	...
	public String getCalendarId() {
		...
		if(principalHRAttributes != null) {
            ...
            if(pcal!= null) {
				CalendarEntry calEntries = TkServiceLocator.getCalendarEntryService().getCurrentCalendarEntryByCalendarId(pcal.getHrCalendarId(), getLeaveLocalDate().toDateTimeAtStartOfDay());
				if(calEntries != null) {
