...
public class PrincipalHRAttributesLookupableHelper extends KPMELookupableHelper {
	...
	public List<? extends BusinessObject> getSearchResults(Map<String, String> fieldValues) {
	    ...
	    return TkServiceLocator.getPrincipalHRAttributeService().getPrincipalHrAtributes(GlobalVariables.getUserSession().getPrincipalId(), principalId, leavePlan, TKUtils.formatDateString(fromEffdt),
