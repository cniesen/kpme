...
public class JobLookupableHelper extends KPMELookupableHelper {
    ...
    public List<? extends BusinessObject> getSearchResults(Map<String, String> fieldValues) {
        ...
        return TkServiceLocator.getJobService().getJobs(GlobalVariables.getUserSession().getPrincipalId(), principalId, firstName, lastName, jobNumber, dept, positionNumber, hrPayType, 
