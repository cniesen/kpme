...
public class EarnCodeSecurityLookupableHelper extends KPMELookupableHelper {
	...
	public List<? extends BusinessObject> getSearchResults(Map<String, String> fieldValues) {
        ...
        return TkServiceLocator.getEarnCodeSecurityService().searchEarnCodeSecurities(GlobalVariables.getUserSession().getPrincipalId(), dept, salGroup, earnCode, location, TKUtils.formatDateString(fromEffdt), 
