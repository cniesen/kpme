 ...
 */
@Entity
@Table(name = "PM_PSTN_CL_GRP_KEY_T")
public class ClassificationGroupKeyBo extends HrBusinessObjectKey<ClassificationBo, ClassificationGroupKeyBo> {
    ...
    public static final ModelObjectUtils.Transformer<EffectiveKey, ClassificationGroupKeyBo> toBo = new ModelObjectUtils.Transformer<EffectiveKey, ClassificationGroupKeyBo>() {
    ...
    public static final ModelObjectUtils.Transformer<ClassificationGroupKeyBo, EffectiveKey> toImmutable = new ModelObjectUtils.Transformer<ClassificationGroupKeyBo, EffectiveKey>() {
