...
public class EdoDossierTypeBo extends HrBusinessObject implements EdoDossierTypeContract {
    ...
    public static final ImmutableList<String> BUSINESS_KEYS = new ImmutableList.Builder<String>().add(KeyFields.DOSSIER_TYPE_CODE).build();
    ...
    public ImmutableMap<String, Object> getBusinessKeyValuesMap() {
        return new ImmutableMap.Builder<String, Object>().put(KeyFields.DOSSIER_TYPE_CODE, this.getDossierTypeCode()).build();
    }
    ...
    @PortableSequenceGenerator(name = "EDO_DOSSIER_TYPE_S")
    @GeneratedValue(generator = "EDO_DOSSIER_TYPE_S")
    @Id
    @Column(name = "EDO_DOSSIER_TYPE_ID", nullable = false, length = 60)
    private String edoDossierTypeId;

    @Column(name = "DOSSIER_TYPE_CODE", nullable = false, length = 2)
    private String dossierTypeCode;

    @Column(name = "DOSSIER_TYPE_NAME", nullable = false, length = 45)
    private String dossierTypeName;

    @Column(name = "DOC_TYPE_NAME", nullable = false, length = 64)
