...
-- moved to rice-kew-0.9.1.3.jar
ALTER TABLE EN_DOC_TYP_T add RPT_WRKGRP_ID NUMBER;
...
;
insert into EN_APPL_CNST_T values ('Config.Application.MinutesToCacheUsers', '40320', 0)
;
insert into EN_APPL_CNST_T values ('RuleChange.IsGenerateActionRequests', 'true', 0)
;
insert into EN_APPL_CNST_T values ('RuleService.IsCaching', 'true', 0)
;
insert into EN_APPL_CNST_T values ('Config.Application.AdminUserList', 'quickstart rkirkend', 0)
;
insert into EN_APPL_CNST_T values ('DocumentSearch.IsRouteLogPopup', 'false', 0)
;
insert into EN_APPL_CNST_T values ('DocumentSearch.IsDocumentPopup', 'false', 0)
;
insert into EN_APPL_CNST_T values ('RouteQueue.isRoutingByIPNumber', 'true', 0)
;
insert into EN_APPL_CNST_T values ('RouteQueue.timeIncrement', '1000', 0)
;
insert into EN_APPL_CNST_T values ('RouteManagerQueue.initialDelay', '1000', 0)
;
insert into EN_APPL_CNST_T values ('RouteManagerQueue.waitTime', '1000', 0)
;
...
;
insert into EN_APPL_CNST_T values ('ActionList.sendEmailNotification', 'false', 0)
;
...
;
insert into EN_APPL_CNST_T values ('docSearch.DocumentSearch.results.label.routeHeaderId', 'Routeheader Id', 0)
;
...
;
insert into EN_APPL_CNST_T values ('RuleAttribute.Search.Instruction', 'Enter rule attribute criteria and click the search button.', 0)
;
...
;
insert into EN_APPL_CNST_T values ('Config.Mailer.IPAddress', '127.0.0.1', 0)
;
insert into EN_APPL_CNST_T values ('Config.Mailer.FromAddress', 'quickstart@localhost', 0)
;
...
;
insert into EN_APPL_CNST_T values ('Workflow.AdminUrls', '/RouteType.do /RouteManagerDriver.do /ApplicationConstants.do /RuleAttribute.do /RuleTemplate.do /WorkflowUser.do /DocumentOperation.do /RouteQueue.do /Ingester.do /Plugin.do', 0)
;
insert into EN_APPL_CNST_T values ('Note.CreateNew.Instruction', 'Create or modify note information.', 0)
;
insert into EN_APPL_CNST_T values ('RouteQueue.requeueWaitTime', '5000', 0)
;