...
<div id="tab-section">
    ...
    <c:if test="${Form.user.currentTargetRoles.timesheetApprover || Form.user.currentTargetRoles.timesheetReviewer }">
        <li id="approvals" class="ui-state-default ui-corner-top"><a href="TimeApproval.do?methodToCall=loadApprovalTab&roleName=">Approvals</a></li>
    </c:if>
    <c:if test="${Form.user.currentTargetRoles.timesheetPayrollProcessor }">
        <li id="payrollProcessor" class="ui-state-default ui-corner-top"><a href="TimeApproval.do?methodToCall=loadApprovalTab&roleName=TK_PY_PROCESSOR">PayrollProcess</a></li>
    </c:if>
