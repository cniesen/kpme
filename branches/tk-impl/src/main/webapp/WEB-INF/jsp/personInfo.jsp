...
<c:set var="Form" value="${IUPersonInfoActionForm}" scope="request"/>
                                    ...
                                    <td colspan="9">
                                        ...
                                        <p>
                                            ...
                                            <c:forEach var="payrollProcessor"
                                                       items="${Form.workAreaToPayrollProcessorPerson[assignment.workArea]}">
                ...
                <table class="roles">
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td>
                            <c:forEach var="workArea" items="${Form.payrollProcessorWorkAreas}" varStatus="row">
                                ${workArea}
                                <c:if test="${!row.last}">,</c:if>
                            </c:forEach>
                        </td>
