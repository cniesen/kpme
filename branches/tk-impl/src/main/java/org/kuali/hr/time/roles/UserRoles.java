...
public interface UserRoles {
    ...
    /**
     * Does the current user have any active payroll processor roles?
     *
     * Payroll processor roles attach at the WorkArea level.
     *
     * @return true if yes, false otherwise.
     */
    ...
    /**
     * Does the current user have any role that grants permission to approve
     * timesheets for payroll processing?
     * @return true if yes, false otherwise.
     */
    public boolean isTimesheetPayrollProcessor();
    
    /**
     * Provides a set of WorkArea names that this user is an payroll processor for.
     * @return a Set<Long> of workarea names.
     */
