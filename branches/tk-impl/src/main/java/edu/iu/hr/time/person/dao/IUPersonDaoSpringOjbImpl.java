package edu.iu.hr.time.person.dao;

import org.kuali.hr.time.person.dao.PersonDaoSpringOjbImpl;
...
public class IUPersonDaoSpringOjbImpl extends PersonDaoSpringOjbImpl {
