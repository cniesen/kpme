...
insert into hr_principal_attributes_t (`hr_principal_attribute_id`, `principal_id`, `pay_calendar`, `service_date`, `fmla_eligible`, `worksman_eligible`, `timezone`, `EFFDT`, `TIMESTAMP`, `OBJ_ID`, `VER_NBR`, `active`) values('10000', 'testuser', 'BWS-CAL', '2012-03-01', 'Y', 'Y', null, '2012-03-01', now(), uuid(), '1', 'Y');
...
insert into hr_job_t (`hr_job_id`, `PRINCIPAL_ID`, `JOB_NUMBER`, `EFFDT`, `dept`, `HR_SAL_GROUP`, `pay_grade`, `TIMESTAMP`, `OBJ_ID`, `VER_NBR`, `comp_rate`, `location`, `std_hours`, `hr_paytype`, `active`, `primary_indicator`, `position_nbr`, `FLSA_STATUS`) values ('10000', 'testuser', '1234', '2012-01-01', 'TEST-DEPT', 'SD1', 'SD1', '2012-01-01 11:00:00', uuid(), '1', '0.000000', 'SD1', '40.00', 'EC1', 'Y',  'Y', 'N', null);
insert into hr_job_t (`hr_job_id`, `PRINCIPAL_ID`, `JOB_NUMBER`, `EFFDT`, `dept`, `HR_SAL_GROUP`, `pay_grade`, `TIMESTAMP`, `OBJ_ID`, `VER_NBR`, `comp_rate`, `location`, `std_hours`, `hr_paytype`, `active`, `primary_indicator`, `position_nbr`, `FLSA_STATUS`) values ('10001', 'testuser', '5678', '2012-01-01', 'TEST-DEPT', 'SD1', 'SD1', '2012-01-01 11:00:00', uuid(), '1', '0.000000', 'SD1', '40.00', 'EC2', 'Y',  'Y', 'N', null);
...
insert into hr_earn_code_t values('10000', 'EC1', 'test1', '2012-02-01', 'Y', 'Y', 'B2991ADA-E866-F28C-7E95-A897AC377D0C', '1', now(), 'testAC', '1.5', '1.5', null, 'Hours');
# earn code with allow_schd_leave = N
insert into hr_earn_code_t values('10001', 'EC2', 'test2', '2012-02-01', 'Y', 'Y', 'B2991ADA-E866-F28C-7E95-A897AC377D0C', '1', now(), 'testAC', '1.5', '1.5', null, 'Hours');