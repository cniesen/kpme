        ...
        <td width="33%" valign="top">
		   <div class="portlet">
			  ...
			  <div class="portlet-content">
					...
					<br/><a href="kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.hr.time.earngroup.EarnGroup&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true&docFormKey=88888888">Earn Group</a>
					...
					<br/><a href="kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.hr.time.roles.TkRole&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true&docFormKey=88888888">Roles</a>
			   
			   		<br/><a href="timeEntry.do?methodToCall=docHandler">Time Entry</a>
			   </div>    
           </div>
           <div class="portlet">
              <div class="header">
