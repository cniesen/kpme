...
public class SerialConnection implements SerialPortEventListener, CommPortOwnershipListener {
    private CardReaderApplet parent;
    ...
    public SerialConnection(CardReaderApplet parent, SerialParameters parameters) {
        this.parent = parent;
    ...
    public void openConnection() throws SerialConnectionException {
        try {
            ...
            try {
                ...
                System.out.println("ignoring caught exception" + e.getMessage());
            }

            Enumeration enumx = CommPortIdentifier.getPortIdentifiers();
            while (enumx.hasMoreElements()) {
                CommPortIdentifier item = (CommPortIdentifier)enumx.nextElement();
            }
            // Obtain a CommPortIdentifier object for the port you want to open.
            portId = CommPortIdentifier.getPortIdentifier(parameters.getPortName());
        } catch (NoSuchPortException nspe) {
            parent.sendMessage(parameters.getPortName() + " can not be found on this machine!\n" + "You should review the Card Reader Setup instructions \n." + "to verify that you have completed all the necessary installation \n" + "steps.");
            parent.setupError();
        } catch (Exception e) {
            parent.sendMessage(parameters.getPortName() + " can not be found on this machine!\n" + "You should review the Card Reader Setup instructions \n." + "to verify that you have completed all the necessary installation \n" + "steps.");
            parent.setupError();
        ...
        // the open call a timeout of 3 seconds to allow
        // a different application to reliquish the port if the user
        // wants to.
        try {
            sPort = (SerialPort)portId.open("SerialDemo", 3000);
        } catch (PortInUseException e) {
            parent.sendMessage(parameters.getPortName() + " is already in use!");
    ...
    public void serialEvent(SerialPortEvent e) {
        ...
        // Read data until -1 is returned. If \r is
        // received substitute
        ...
        case SerialPortEvent.DATA_AVAILABLE:
            while (newData != -1) {
                try {
                    ...
                    parent.showStatus(ex.getMessage());
                    return;
                }
            }
            // Send card String back to the CardReaderApplet.
            parent.cardRead(new String(inputBuffer));
            break;
        }
    }
    ...
    public void ownershipChange(int type) {
        //this method must be implemented in order for us to implement
