...
public abstract class AbstractHourlyHoursRule extends AbstractPersistentDatabaseEntity implements EffectiveDatedObject, EffectiveSequencedObject, EffectiveStatusedObject {
	...
	private BigDecimal dailyMaxHours;
	private BigDecimal dailyMinHours;
	private BigDecimal weeklyMaxHours;
	private BigDecimal weeklyMinHours;
	private String userUniversityId;
	private Timestamp timestamp;

	public AbstractHourlyHoursRule() {
		super();
	}
	...
	public BigDecimal getDailyMaxHours() {
		return dailyMaxHours;
	}

	public void setDailyMaxHours(BigDecimal dailyMaxHours) {
		this.dailyMaxHours = dailyMaxHours;
	}

	public BigDecimal getDailyMinHours() {
		return dailyMinHours;
	}

	public void setDailyMinHours(BigDecimal dailyMinHours) {
		this.dailyMinHours = dailyMinHours;
	}

	public BigDecimal getWeeklyMaxHours() {
		return weeklyMaxHours;
	}

	public void setWeeklyMaxHours(BigDecimal weeklyMaxHours) {
		this.weeklyMaxHours = weeklyMaxHours;
	}

	public BigDecimal getWeeklyMinHours() {
		return weeklyMinHours;
	}

	public void setWeeklyMinHours(BigDecimal weeklyMinHours) {
