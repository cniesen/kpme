...
<div class="body">
    ...
    <ul class="chan">
        <li>
            <portal:portalLink displayTitle="true" title="Khr Employee Setup"
                               url="${ConfigProperties.application.url}/kr-krad/lookup?methodToCall=start&dataObjectClassName=org.kuali.kpme.core.tkmdocument.KhrEmployeeDocument&returnLocation=${ConfigProperties.application.url}/portal.do&showMaintenanceLinks=true&hideReturnLink=true&docFormKey=88888888&active=Y" />
        </li>
        <li>
