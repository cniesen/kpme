...
<div class="portlet">
    ...
    <div class="body">
        <ul>
	        ...
	        <li>
	            <a href="${ConfigProperties.application.url}/kew/DocumentSearch.do?documentTypeName=MissedPunchDocumentType&returnLocation=${ConfigProperties.application.url}/DepartmentAdmin.do&hideReturnLink=true&docFormKey=88888888&active=Y">Missed Punch</a>
	        </li>
            <li>
