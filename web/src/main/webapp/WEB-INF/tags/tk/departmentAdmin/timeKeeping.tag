...
<div class="portlet">
    ...
    <div class="body">
    	...
    	<ul class="chan">
            <li>
                <a href="${ConfigProperties.application.url}/kr-krad/lookup?methodToCall=start&dataObjectClassName=org.kuali.kpme.tklm.time.clocklog.RemoteSwipeDevice&returnLocation=${ConfigProperties.application.url}/DepartmentAdmin.do&showMaintenanceLinks=true&hideReturnLink=true&docFormKey=88888888&active=Y">Remote Card Swipe Devices</a>
            </li>
            <li>
